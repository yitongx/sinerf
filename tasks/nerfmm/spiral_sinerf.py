...
from tasks.nerfmm.train_eval_sinerf import model_render_image
from utils.comp_ray_dir import comp_ray_dir_cam_fxfy
from utils.lie_group_helper import convert3x4_4x4
from utils.pose_utils import create_spiral_poses
from utils.training_utils import load_ckpt_to_net, set_randomness
...
def parse_args():
    ...
    parser.add_argument('--base_dir', type=str, default='./data/LLFF', help='folder contains various scenes')
    ...
    parser.add_argument('--den_mag', type=float, default=30.0)
